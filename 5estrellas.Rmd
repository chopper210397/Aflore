...
timeline<-read_xlsx("~/Documentos/GitHub/LabJournalWebsite-master/docs/5estrellas_files/solicitudes_5_1marzo_27abril.xlsx")
...
b %>% filter(fecha<"31-03-20")
b[34:57,]

plot(ts(data = b[34:57,]$valor))
```
