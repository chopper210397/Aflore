...
solicitudes<-read.csv("~/Documentos/GitHub/LabJournalWebsite-master/docs/solicitudes_consejeros_1_20_abril.csv",sep=";")
timeline<-read_xlsx("~/Documentos/GitHub/LabJournalWebsite-master/docs/solicitudes_5_1abril_27abril.xlsx")
...
En los días de semana santa se ve una caída en el número de solicitudes para 5 estrellas, esta tendencia se revierte para el lunes 18 y 19 de abril, a partir del 21 se vuelven a caer el número de solicitudes hasta el día 25 que vuelven a subir los valores.
